...
import {MdOutlineCheckBox, MdOutlineNavigateNext, MdSend} from "react-icons/md";
...
const Navbar = (props) => {
  ...
  return (
    <nav className="sticky top-0 z-40 flex flex-row flex-wrap items-center justify-between rounded-xl bg-white/10 p-4 pt-0 backdrop-blur-2xl dark:bg-[#0b14374d]">
        ...
        <p className="shrink text-[33px] capitalize text-navy-700 dark:text-white">
          ...
          >
            <img
                ...
                className="mt-4 w-32 sm:w-20  xs:w-10 " // Adjust width for different screen sizes
                src={bmti}
      ...
      <div>
        <div className="col-span-1 h-full w-full rounded-xl 2xl:col-span-1 ">
          ...
          <div
              className=" flex text-white w-full items-center rounded-3xl justify-between  bg-blue-500 hover:bg-blue-600 p-2  shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">


            <div>
              <Link to={"/student/appeals"} className="text-xl sm:text-lg xs:text-md font-medium dark:text-white w-full sm:w-auto">
                Mening Arizalarim
              </Link>
